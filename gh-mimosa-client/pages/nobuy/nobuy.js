            ...
            pagesInit: function() {
                ...
                var noCardConfig = {
                    ajax: function(origin) {
                        http.post(util.buildQueryUrl(config.api.ope.nobuy.list, {
                ...
                var bindCardConfig = {
                    ajax: function(origin) {
                        http.post(util.buildQueryUrl(config.api.ope.nobuy.list, {
                            ...
                            isBuy: bindCardOptions.isBuy,
                            buyTimeBegin: bindCardOptions.buyTimeBegin,
                            buyTimeEnd: bindCardOptions.buyTimeEnd
                        }), function(rlt) {
                            origin.success(rlt)
                        })
                    },
                ...
                $(document.bindCardSearchForm.buyTimeBegin).val(tim);
...
//					noCardOptions.rechargeTimeEnd = getNextDate(noCardOptions.rechargeTimeEnd)	// 结束时间加一天
                ...
                function getBindCardQueryParams(val) {
                    ...
                    bindCardOptions.buyTimeBegin = form.buyTimeBegin.value.trim()
                    bindCardOptions.buyTimeEnd = form.buyTimeEnd.value.trim()
            ...
            bindEvent: function() {
                ...
                $("#approveBut").on('click', function() {
                    ...
                    $('#approveForm').ajaxSubmit({
                        url: config.api.ope.nobuy.feedback,
